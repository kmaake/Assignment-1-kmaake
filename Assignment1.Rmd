...
2.  The scientific community creates a single place for authors in all fields to make their studies reproducible.
    ...
    -   In order to accomplish this the community would need to create a common DataMed central, CodeMed central and PubMed central where publishers/authors data, metadata, and code can be stored with their studies. This would require additional costs and would need to be coordinated and supported by the government.
