...
A computable document meaning the container for the different elements that make up a document and its computations [@gentleman2004].
These code chunks being sequences of commands in the programming language R [@gentleman2004].
With the possibility to the describe the code, the results and their interpretation with text chunks [@gentleman2004].
